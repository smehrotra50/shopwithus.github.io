...
<style>
  ...
  <div class="menu-wrap">
    ...
    <div class="container">
	  ...
	  <p>To reset your password, enter your Phone No. and Email ID.</p>
	  <br></br>
		  ...
		  <input type="phone" placeholder="Enter Phone No." name="phone" required>
              <br></br>
			  <div class="clearfix">
	<button type="back" class="cancelbtns">Back</button>
   <button type="next" class="signupbtn"><a href="login.html"/>Next</button>
    </div>
			</div> 
